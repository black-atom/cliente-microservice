...
const stockSchema = new Schema({
    ...
    idProduct: { type: String, default: "", required: [true, "Entre a descricao o id do produto"] },
    quantity: { type: Number, default: 1, required: [true, "Entre a quantidade do produto"] },
    idOrigin: { type: String, default: "", required: [true, "Entre com o id da origin"]},
...
module.exports = dbConnection.model("stocks", orderCompraSchema);